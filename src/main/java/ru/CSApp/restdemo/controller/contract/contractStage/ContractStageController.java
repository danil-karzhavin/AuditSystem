...
public class ContractStageController {
    ...
    public ResponseEntity<Object> createContractStageForContract(@PathVariable("contractId") Integer contractId, @RequestBody ContractStageDto contractStageDto){
        return ResponseEntity.ok(contractStageService.createContractStageForContract(contractId, contractStageDto));
    }

    @PutMapping("/")
    public ResponseEntity<Object> updateContractStage(@RequestBody ContractStageDto contractStageDto){
        return ResponseEntity.ok(contractStageService.updateContactStage(contractStageDto));
    }
